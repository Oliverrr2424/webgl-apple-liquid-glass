...
const STRINGS = {
  en: {
    ...
    'slider.v2.edgeReach': 'Capture reach ratio',
    'slider.v2.edgeWidth': 'Pull width',
    'slider.v2.dispersion': 'Dispersion',
    'slider.v2.frost': 'Softness ratio',
    'slider.v2.backdropBlur': 'Background pre-blur (px)',
    'group.navLens': 'Navigation lens (Press scene)',
    'navLens.outerWidth': 'Outer lens width growth',
    'navLens.outerHeight': 'Outer lens height (× bar)',
    'navLens.innerLength': 'Inner glass length kept',
    'navLens.innerHeight': 'Inner glass height kept',
  ...
  zh: {
    ...
    'slider.v2.edgeReach': '捕捉比例',
    'slider.v2.edgeWidth': '拉伸宽度',
    'slider.v2.dispersion': '色散',
    'slider.v2.frost': '柔化比例',
    'slider.v2.backdropBlur': '背景预模糊（px）',
    'group.navLens': '导航透镜（按压场景）',
    'navLens.outerWidth': '外层透镜加宽',
    'navLens.outerHeight': '外层透镜高度（×轨道）',
    'navLens.innerLength': '内层玻璃保留长度',
    'navLens.innerHeight': '内层玻璃保留高度',
    'glass.light': '浅色玻璃',
    'glass.dark': '深色玻璃',
    'slider.v2.body': '玻璃主体',
